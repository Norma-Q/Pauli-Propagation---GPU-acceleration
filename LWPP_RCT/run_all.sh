...
CONFIG_PATH="${SCRIPT_DIR}/q25_experiment_config.json"
RUNNER="${SCRIPT_DIR}/run_q25_experiment.py"

echo "Starting Q25 batch"
...
"${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 1 --depth 6 --skip-aggregate
"${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 2 --depth 6 --skip-aggregate
"${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 3 --depth 6 --skip-aggregate
"${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 4 --depth 6 --skip-aggregate
...
# "${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 1 --depth 9 --skip-aggregate
# "${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 2 --depth 9 --skip-aggregate
# "${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 3 --depth 9 --skip-aggregate
# "${PYTHON_BIN}" "${RUNNER}" --config "${CONFIG_PATH}" --init-strategy tqa --seed 4 --depth 9 --skip-aggregate
